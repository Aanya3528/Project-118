...
function example(){
    ...
    window.open("https://www.google.com/search?q="+sketch+"&tbm=isch&chips=q:butterfly,g_1:clip+art:zLe3OGpBYno%3D&hl=en-GB&sa=X&ved=2ahUKEwiBy77RkfL2AhWRRGwGHQkoC5sQ4lYoBHoECAEQJA&biw=1579&bih=712", "_blank");
    let utterance = new SpeechSynthesisUtterance("Here are some examples for"+sketch);
